          ...
          for (const record of allRecords) {
            try {
              ...
              if (obj.type === 'vendor_resources') {
                ...
                // GHL appends _partner to multi-select category field keys
                // e.g. deals_opportunities => deals__opportunities_partner
                // Boolean fields return as arrays e.g. ["true"] -- parseBool handles both
                upsertRow = {
                  ghl_record_id: recId,
                  ...
                  company_postal_code: String(props.company_postal_code || ''),
                  ...
                  team_vendors:         parseArray(props.team__vendors_partner        || props.team_vendors),
                  attorney_subclass:    parseArray(props.attorney_subclass_partner || props.attorney__subclass_partner || props.attorney_subclass),
                  operations:           parseArray(props.operations_partner           || props.operations),
                  development_land:     parseArray(props.development__land_partner    || props.development_land),
                  education_tech_tools: parseArray(props.education_technology__tools_partner || props.education__tech__tools_partner || props.education_tech_tools),
                  // Social fields use social_profile_links_ prefix
  ...
  try {
    ...
    if (objectType === 'vendor_resources') {
      const row = {
        ...
        funding_financial:      parseArray(body.funding__financial_partner   || body.funding_financial),
        team_vendors:           parseArray(body.team__vendors_partner        || body.team_vendors),
        attorney_subclass:      parseArray(body.attorney_subclass_partner || body.attorney__subclass_partner || body.attorney_subclass),
        operations:             parseArray(body.operations_partner           || body.operations),
        development_land:       parseArray(body.development__land_partner    || body.development_land),
        education_tech_tools:   parseArray(body.education_technology__tools_partner || body.education__tech__tools_partner || body.education_tech_tools),
        other_contractor:       parseArray(body.other_contractor),
        social_facebook:        body.social_profile_links_facebook  || body.social_facebook  || '',
        social_instagram:       body.social_profile_links_instagram || body.social_instagram || '',
        social_youtube:         body.social_profile_links_youtube   || body.social_youtube   || '',
        social_linkedin:        body.social_profile_links_linkedin  || body.social_linkedin  || '',
