            ...
            try {
              ...
              if (obj.type === 'vendor_resources') {
                ...
                upsertRow = {
                  ...
                  attorney_subclass:    parseArray(props.attorney__subclass_partner   || props.attorney_subclass),
                  ...
                  education_tech_tools: parseArray(props.education__tech__tools_partner || props.education_tech_tools),
  ...
  try {
    ...
    if (objectType === 'vendor_resources') {
      const row = {
        ...
        attorney_subclass:      parseArray(body.attorney__subclass_partner   || body.attorney_subclass),
        ...
        education_tech_tools:   parseArray(body.education__tech__tools_partner || body.education_tech_tools),
