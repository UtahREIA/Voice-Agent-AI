...
│   ├── sync-ghl-objects.js # GHL custom object sync webhook receiver
...
| `ghl_vendor_resources` | 12 | Synced vendor records |
| `ghl_educators_mentors` | 1 | Synced educator records |
| `ghl_educational_courses` | 5 | Synced course records |
| `ghl_tools_resources` | 2 | Synced tool records |
